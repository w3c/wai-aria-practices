...
<div>
    ...
    <li>
        ...
        <a href="{{ site.baseurl }}/practices/read-me-first/#no_aria_better_bad_aria">No ARIA is better than Bad ARIA</a>.
          ...
          <img alt=""
        src="{{ site.baseurl }}/assets/img/link.svg"
  ...
  <p>
    ...
    <a href="{{ site.baseurl }}/patterns/link/">design pattern for link</a>.
  ...
  <nav>
    <a href="{{ site.baseurl }}/patterns/link/">Link Design Pattern in WAI-ARIA Authoring Practices 1.2</a>
  </nav>
