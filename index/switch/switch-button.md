...
ref: /WAI/ARIA/APG/index/switch/switch-button

github:
  repository: w3c/aria-practices
  path: aria-practices.html
feedbackmail: public-aria-practices@w3.org
permalink: /WAI/ARIA/APG/index/switch/switch-button
...
<div>
  ...
  <div>
    ...
    <p>
      This example illustrates implementing the <a href="/WAI/ARIA/APG/patterns/switch/">switch design pattern</a> with an HTML <code>button</code> as a switch element and using an <code>SVG</code> element to provide graphical rendering of switch states.
