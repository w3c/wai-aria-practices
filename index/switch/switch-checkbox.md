...
<div>
  ...
  <div>
    ...
    <p>
      This example illustrates implementing the <a href="{{ site.baseurl }}/patterns/switch/">Switch design pattern</a> with  an HTML <code>input[type="checkbox"]</code> as the switch element and  using CSS borders to provide graphical rendering of switch states.
