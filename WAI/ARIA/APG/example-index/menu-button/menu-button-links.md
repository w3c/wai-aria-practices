...
ref: /WAI/ARIA/APG/example-index/menu-button/menu-button-links
...
permalink: /WAI/ARIA/APG/example-index/menu-button/menu-button-links
...
<div>
    ...
    <div>
      ...
      <p>
        ...
        <a href="undefined">Roles That Automatically Hide Semantics by Making Their Descendants Presentational.</a>
      </p>
            ...
            <tr data-test-id="none-role">
              ...
              <td>
                <ul>
                  ...
                  <li>For more details, see <a href="undefined">Intentionally Hiding Semantics with the <code>presentation</code> Role</a>.</li>
                </ul>
              </td>
            </tr>
