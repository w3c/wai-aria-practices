...
ref: /WAI/ARIA/APG/example-index/switch/switch-checkbox
...
permalink: /WAI/ARIA/APG/example-index/switch/switch-checkbox

sidebar: true

footer: "          <div class='example-page-footer'>            <p><a href='https://github.com/w3c/aria-practices/projects/2'>View issues related to this example</a></p>            <p>Page last updated: November 10, 2021</p>          </div>        "
...
<div>
  ...
  <div>
    ...
    <p>
      This example illustrates implementing the <a href="/WAI/ARIA/APG/patterns/switch/">Switch design pattern</a> with  an HTML <code>input[type="checkbox"]</code> as the switch element and  using CSS borders to provide graphical rendering of switch states.
