...
footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/3'>View issues related to this example</a></p>        <p>Page last updated: 10 October 2023</p>      </div>    "
        ...
        <div id="ex1">
          ...
          <div id="id-rating"
            ...
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="386" height="96">
              <rect class="focus-ring" x="23" y="2" width="358" height="90" rx="5" ></rect>
              <g class="rating-1">
                <circle class="value" cx="66" cy="20" r="10"></circle>
                <circle class="focus" cx="66" cy="20" r="14"></circle>
              ...
              <g class="rating-2">
                <circle class="value" cx="96" cy="20" r="10"></circle>
                <circle class="focus" cx="96" cy="20" r="14"></circle>
                <text class="label" x="92" y="50">2</text>
              </g>
              <g class="rating-3">
                <circle class="value" cx="126" cy="20" r="10"></circle>
                <circle class="focus" cx="126" cy="20" r="14"></circle>
                <text class="label" x="120" y="50">3</text>
              </g>
              <g class="rating-4">
                <circle class="value" cx="156" cy="20" r="10"></circle>
                <circle class="focus" cx="156" cy="20" r="14"></circle>
                <text class="label" x="152" y="50">4</text>
              </g>
              <g class="rating-5">
                <circle class="value" cx="186" cy="20" r="10"></circle>
                <circle class="focus" cx="186" cy="20" r="14"></circle>
                <text class="label" x="182" y="50">5</text>
              </g>
              <g class="rating-6">
                <circle class="value" cx="216" cy="20" r="10"></circle>
                <circle class="focus" cx="216" cy="20" r="14"></circle>
                <text class="label" x="212" y="50">6</text>
              </g>
              <g class="rating-7">
                <circle class="value" cx="246" cy="20" r="10"></circle>
                <circle class="focus" cx="246" cy="20" r="14"></circle>
                <text class="label" x="242" y="50">7</text>
              </g>
              <g class="rating-8">
                <circle class="value" cx="276" cy="20" r="10"></circle>
                <circle class="focus" cx="276" cy="20" r="14"></circle>
                <text class="label" x="272" y="50">8</text>
              </g>
              <g class="rating-9">
                <circle class="value" cx="306" cy="20" r="10"></circle>
                <circle class="focus" cx="306" cy="20" r="14"></circle>
                <text class="label" x="302" y="50">9</text>
               </g>
              <g class="rating-10">
                <circle class="value" cx="336" cy="20" r="10"></circle>
                <circle class="focus" cx="336" cy="20" r="14"></circle>
