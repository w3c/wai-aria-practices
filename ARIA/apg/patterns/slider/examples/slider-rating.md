      ...
      <section>
        ...
        <div id="ex1">
          ...
          <div id="id-rating"
            ...
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="382" height="92">
              <rect class="focus-ring" x="2" y="2" width="378" height="90" rx="5" ></rect>
              <g class="rating-0">
                <circle class="value" cx="40" cy="20" r="10"></circle>
                <circle class="focus" cx="40" cy="20" r="14"></circle>
                <text class="label" x="36" y="50">0</text>
                <text class="description"  x="0" y="65">Unacceptable</text>
              </g>
              <g class="rating-1">
                <circle class="value" cx="70" cy="20" r="10"></circle>
                <circle class="focus" cx="70" cy="20" r="14"></circle>
                <text class="label" x="66" y="50">1</text>
              </g>
              <g class="rating-2">
                <circle class="value" cx="100" cy="20" r="10"></circle>
                <circle class="focus" cx="100" cy="20" r="14"></circle>
                <text class="label" x="96" y="50">2</text>
              </g>
              <g class="rating-3">
                <circle class="value" cx="130" cy="20" r="10"></circle>
                <circle class="focus" cx="130" cy="20" r="14"></circle>
                <text class="label" x="126" y="50">3</text>
              </g>
              <g class="rating-4">
                <circle class="value" cx="160" cy="20" r="10"></circle>
                <circle class="focus" cx="160" cy="20" r="14"></circle>
                <text class="label" x="156" y="50">4</text>
              </g>
              <g class="rating-5">
                <circle class="value" cx="190" cy="20" r="10"></circle>
                <circle class="focus" cx="190" cy="20" r="14"></circle>
                <text class="label" x="186" y="50">5</text>
              </g>
              <g class="rating-6">
                <circle class="value" cx="220" cy="20" r="10"></circle>
                <circle class="focus" cx="220" cy="20" r="14"></circle>
                <text class="label" x="216" y="50">6</text>
              </g>
              <g class="rating-7">
                <circle class="value" cx="250" cy="20" r="10"></circle>
                <circle class="focus" cx="250" cy="20" r="14"></circle>
                <text class="label" x="246" y="50">7</text>
              </g>
              <g class="rating-8">
                <circle class="value" cx="280" cy="20" r="10"></circle>
                <circle class="focus" cx="280" cy="20" r="14"></circle>
                <text class="label" x="276" y="50">8</text>
              </g>
              <g class="rating-9">
                <circle class="value" cx="310" cy="20" r="10"></circle>
                <circle class="focus" cx="310" cy="20" r="14"></circle>
                <text class="label" x="306" y="50">9</text>
               </g>
              <g class="rating-10">
                <circle class="value" cx="340" cy="20" r="10"></circle>
