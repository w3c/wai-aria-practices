...
footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/11'>View issues related to this example</a></p>        <p>Page last updated: 29 July 2024</p>      </div>    "
    ...
    <div data-content-phase="experimental">
      ...
      <section>
        ...
        <p>
          ...
          The remove icon is referenced by <code>aria-actions</code>, which enables it to be activated by an assistive technology user while focus is on the tab.
        </p>
