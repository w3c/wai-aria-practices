...
title: "[Experimental] File Directory Treeview Example Using Computed Properties"
ref: /ARIA/apg/patterns/treeview/examples/treeview-1c/

github:
  repository: w3c/aria-practices
  branch: main
  path: content/patterns/treeview/examples/treeview-1c.html
feedbackmail: public-aria-practices@w3.org
permalink: /ARIA/apg/patterns/treeview/examples/treeview-1c/

sidebar: true

footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/17'>View issues related to this example</a></p>        <p>Page last updated: 27 March 2024</p>      </div>    "
...
<div>
    ...
    <div data-content-phase="experimental">
      ...
      <section>
        ...
        <p>
          This experimental version of the File Directory Treeview Example Using Declared Properties example is not intended to ever be released or shown to the public. 
          It exists merely to ensure that experimental content support can be adequately developed and tested.
          When support is fully implemented, this example can be deleted.
        </p>
        <p>
      ...
      <section>
        <div class="example-header">
          <h2 id="start">Experimental Example</h2>
        </div>
