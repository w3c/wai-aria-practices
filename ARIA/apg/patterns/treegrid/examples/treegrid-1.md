...
footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/17'>View issues related to this example</a></p>        <p>Page last updated: 11 July 2023</p>      </div>    "
          ...
          <div class="table-wrap"><table id="treegrid" role="treegrid" aria-label="Inbox">
            ...
            <thead>
              <tr>
                ...
                <th scope="col" id="email-status-label">Status</th>
                <th scope="col" id="email-notes-label">Notes</th>
              </tr>
            </thead>
            <tbody>
              <tr id="row-1" role="row" aria-level="1" aria-posinset="1" aria-setsize="1" aria-expanded="true">
                ...
                <td>
                  <select aria-labelledby="email-action-label row-1">
                ...
                <td>
                  <input type="text" aria-labelledby="email-notes-label row-1">
                </td>
              </tr>
