      ...
      <section id="roles_states_properties">
        ...
        <ul>
          ...
          <li>
            ...
            Each parent row has the <a class="property-reference" href="https://w3c.github.io/aria/#aria-expanded">aria-expanded</a> state set on either the row element or on a cell contained in therow.
