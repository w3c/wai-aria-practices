...
footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/13'>View issues related to this example</a></p>        <p>Page last updated: 17 February 2023</p>      </div>    "
...
<div>
  ...
  >
      ...
      <section>
        <h2 id="accessibilityfeatures">Accessibility Features</h2>
        <ol>
          <li>
          ...
          <li>
            ...
            Selected options have a check preceeding the text label for the option.
          </li>
          <li>
