...
footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/orgs/w3c/projects/131'>View issues related to this example</a></p>        <p>Page last updated: 6 November 2025</p>      </div>    "
            ...
            <div>
              ...
              <ul id="ss_elem_list" tabindex="0" role="listbox" aria-labelledby="ss_elem">
                ...
                <li id="ss_elem_Np" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Neptunium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton hide-actions-button" id="ss_elem_Np_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Np_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Np_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Np_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Pu" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Plutonium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Pu_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Pu_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Pu_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Pu_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Am" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Americium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Am_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Am_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Am_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Am_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Cm" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Curium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Cm_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Cm_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Cm_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Cm_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Bk" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Berkelium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Bk_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Bk_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Bk_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Bk_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Cf" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Californium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Cf_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Cf_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Cf_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Cf_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Es" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Einsteinium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Es_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Es_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Es_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Es_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Fm" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Fermium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Fm_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Fm_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Fm_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Fm_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Md" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Mendelevium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Md_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Md_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Md_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Md_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_No" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Nobelium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_No_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_No_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_No_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_No_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Lr" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Lawrencium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Lr_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Lr_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Lr_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Lr_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Rf" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Rutherfordium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Rf_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Rf_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Rf_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Rf_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Db" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Dubnium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Db_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Db_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Db_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Db_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Sg" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Seaborgium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Sg_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Sg_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Sg_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Sg_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Bh" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Bohrium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Bh_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Bh_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Bh_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Bh_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Hs" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Hassium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Hs_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Hs_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Hs_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Hs_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Mt" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Meitnerium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Mt_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Mt_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Mt_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Mt_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Ds" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Darmstadtium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Ds_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Ds_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Ds_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Ds_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Rg" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Roentgenium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Rg_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Rg_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Rg_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Rg_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Cn" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Copernicium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Cn_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Cn_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Cn_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Cn_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Nh" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Nihonium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Nh_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Nh_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Nh_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Nh_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Fl" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Flerovium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Fl_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Fl_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Fl_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Fl_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Mc" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Moscovium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Mc_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Mc_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Mc_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Mc_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Lv" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Livermorium <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Lv_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Lv_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Lv_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Lv_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Ts" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Tennessine <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Ts_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton" id="ss_elem_Ts_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Ts_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Ts_delete"></button>
                  </span>
                </li>
                <li id="ss_elem_Og" role="option" aria-actions="">
                  <span class="checkmark" aria-hidden="true"></span>
                  Oganesson <span class="offscreen favoriteindication"></span>
                  <span class="actions">
                    <button aria-label="move up" class="uparrow actionbutton" id="ss_elem_Og_uparrow"></button>
                    <button aria-label="move down" class="downarrow actionbutton hide-actions-button" id="ss_elem_Og_downarrow"></button>
                    <button aria-label="favorite" class="favorite actionbutton" id="ss_elem_Og_favorite"></button>
                    <button aria-label="delete" class="delete actionbutton" id="ss_elem_Og_delete"></button>
                  </span>
                </li>
              </ul>
            </div>
