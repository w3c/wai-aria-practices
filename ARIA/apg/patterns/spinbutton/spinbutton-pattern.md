...
<div>
    ...
    <div>
      ...
      <section id="examples" class="examples-section">
        ...
        <h2>Example</h2>
        <p><a href="examples/quantity-spinbuttons/">Quantity Spin Button Example:</a> A set of three spin buttons to collect the quantities of adults, children, and animals for a hotel reservation.</p>
      </section>
