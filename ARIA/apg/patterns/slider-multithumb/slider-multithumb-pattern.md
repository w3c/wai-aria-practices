...
github:
  ...
  branch: main
  path: patterns/slider-multithumb/slider-multithumb-pattern.html
...
<html lang="en">
  ...
  <body>
    <main>
      <h1>Slider (Multi-Thumb) Pattern</h1>

      <section id="about">
        <h2>About This Pattern</h2>
        <p>
          A multi-thumb slider implements the <a href="../slider/slider-pattern.html">Slider Pattern</a> but includes two or more thumbs, often on a single rail.
      ...
      <section id="examples">
        <h2>Example</h2>
        <p><a href="examples/slider-multithumb.html">Horizontal Multi-Thumb Slider Example</a>: Demonstrates a two-thumb slider for picking a price range for a hotel reservation.</p>
      </section>
