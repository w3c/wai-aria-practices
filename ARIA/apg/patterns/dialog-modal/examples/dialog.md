...
footer: "      <div class='example-page-footer'>        <p><a href='https://github.com/w3c/aria-practices/projects/6'>View issues related to this example</a></p>        <p>Page last updated: 13 February 2024</p>      </div>    "
    ...
    <div>
      ...
      <section id="at-support">
        ...
        <iframe class="support-levels-modal-dialog"
          src="https://aria-at-app-sandbox.bocoup.com/embed/reports/modal-dialog"
          height="100"
