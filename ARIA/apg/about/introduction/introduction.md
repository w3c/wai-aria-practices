    ...
    <div>
      ...
      <section id="apg-is--not-normative">
        ...
        <p>
          ...
          For example, the patterns include keyboard interaction models that combine a normative requirement specified by ARIA with conventions established by popular operating systems and software.
      ...
      <section id="prerequisite-knowledge">
        <h2>Assumed Prerequisite Knowledge</h2>
        <p>
          The APG covers only a portion of what is needed to create accessible experiences, so it necessarily assumes readers have some knowledge of several related topics.
          This section describes those topics and supporting resources so readers can derive maximum benefit from the APG.
        </p>
        <p>
