    ...
    <div>
      ...
      <section id="os-high-contrast">
        ...
        <div class="table-wrap"><table class="data">
          <caption>Overview of Operating System and Browser Contrast Adjustment Features</caption>
          <thead>
            <tr>
              <th>Feature</th>
              <th>Platforms</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <p>
                  When this setting is enabled, some browsers set the CSS media query <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@media/inverted-colors"><code>inverted-colors</code></a> to <code>invert</code>.
                </p>
                <p>Inverting of colors can have unpleasant side effects, such as shadows turning into highlights, which can reduce the readability of the content, use gradients instead.
                </p>
                <p>
                  For content to render well when invert colors is enabled, ensure it meets the minimum color requirements specified by <a href="https://www.w3.org/TR/WCAG22/">Web Content Accessibility Guidelines</a> (WCAG) and avoid using shadows.
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  ...
                  <li><a href="https://support.apple.com/en-is/guide/iphone/iph3c076905a/26/ios/26">iOS</a></li>
                </ul>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li><a href="https://support.microsoft.com/en-US/accessibility/windows/change-color-contrast-in-windows">Windows</a></li>
                  <li><a href="https://support.mozilla.org/en-US/kb/firefox-contrast-control">Firefox</a></li>
                </ul>
              </td>
              <td>
                Operating system and browser accessibility feature that automatically forces content to render using an alternative color theme chosen by the user.
                Contrast themes are often designed to provide extra high contrast.
                Browsers replace author specified colors with colors that users specify for various types of HTML elements.
              ...
              <td>
                When a user enables a contrast theme, the CSS media query <code>forced-colors</code> is set to <code>active</code>.
      ...
      <section id="invert-colors">
        ...
        <p>
          ...
          <p><strong>Note:</strong> The <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@media/inverted-colors"><code>inverted-colors: inverted</code></a> CSS media query can be used to detect when the user setting for inverting colors, but it is not widely supported in browsers.
        </p>

        <h3 id="invert-colors-example">Invert Colors Example</h3>

        <p>
          The following images illustrate how a <code>switch</code> element is rendered on macOS both when invert colors is disabled and enabled.
        </p>

        <div class="table-wrap"><table class="data" aria-labelledby="invert-colors-example">
          <thead>
            <tr>
              <th>Setting</th>
              <th>Screen Shot</th>
        ...
        <h3 id="invert-colors-supporting">Supporting Invert Colors</h3>

        <ol>
          <li>
            Develop a default color scheme that meets
          <a href="https://www.w3.org/TR/WCAG22/#contrast-minimum">WCAG 1.4.3: Contrast (Minimum)</a> requirement.
          </li>
          <li>Avoid using shadow styling, use gradients instead.</li>
        </ol>

        <h3 id="invert-colors-testing">Testing Invert Colors</h3>

        <p>In each operating system used by the target audience:</p>
        <ol>
          <li>Turn on the invert colors feature, which is typically located in accessibility settings.</li>
          <li>
      ...
      <section id="prefers-contrast">
        ...
        <div class="table-wrap"><table class="data">
          ...
          <thead>
            <tr>
              ...
              <th>Text</th>
              <th>Text Color Contrast</th>
              <th>Button Background</th>
              <th>Button Fill</th>
              <th>Button Color Contrast</th>
            </tr>
          </thead>
          <tbody>
            <tr>
        ...
        <h4>Increase Contrast CSS Media Query Code</h4>
  ...
  button[role="switch"] {
    ...
    svg {
      ...
      circle {
        ...
        <h3 id="prefers-contrast-supporting">Supporting Increase Contrast</h3>
        ...
        <h3 id="prefers-contrast-testing">Testing Increase Contrast</h3>
      ...
      <section id="color-scheme">
        ...
        <h4>Color Scheme CSS Media Query Code</h4>
  ...
  svg {
    ...
    circle {
      &.off {
        ...
        <h3 id="color-scheme-supporting">Supporting Color Scheme</h3>
        <ol>
          <li>
            Develop both a light scheme, with dark text on a light background, and a dark scheme, with light text on a dark background.
            Choose color palettes that are easy to read in both schemes and ensure that text and components meet or exceed the color contrast ratios specified by
            <a href="https://www.w3.org/TR/WCAG21/#contrast-minimum">WCAG 1.4.3: Contrast (Minimum)</a>.
          </li>
          <li>
            In dark schemes, consider using highlights and gradients instead of relying on shadows to distinguish components,
            since shadows may be difficult to perceive against dark backgrounds.
          </li>
          <li>
            Allow the active color scheme to respond to the user's color scheme preference.
            The CSS <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme">media query <code>prefers-color-scheme</code></a>
            can be used to apply different styles based on whether the user's preferred color scheme is <code>light</code> or <code>dark</code>.
            The CSS <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/color_value/light-dark"><code>light-dark()</code> function</a>
            can be used to select between two CSS values based on the color scheme in effect, without requiring separate styles in a <code>prefers-color-scheme</code> media query.
          </li>
        </ol>

        <p>Dark mode design resources:</p>
        <ul>
          <li><a href="https://css-tricks.com/a-complete-guide-to-dark-mode-on-the-web/">CSS-Tricks: Dark Mode in CSS Guide</a></li>
          <li><a href="https://www.uxdesigninstitute.com/blog/dark-mode-design-practical-guide/">UX Design Institute: How to design for dark mode: a practical guide</a></li>
        </ul>

        <h3>Testing Color Scheme</h3>
      ...
      <section id="contrast-themes">
        <h2>Contrast Themes (Forced Colors)</h2>
        <p>
          Contrast themes are an accessibility setting available in
          <a href="https://support.microsoft.com/en-US/accessibility/windows/change-color-contrast-in-windows">Windows</a>
          and <a href="https://support.mozilla.org/en-US/kb/firefox-contrast-control">Firefox</a>
          that automatically forces apps and content to render using an alternative color theme chosen by the user.
          In addition to forcing color changes the browser also ignores background images and gradients.
          Note that Chrome both responds to the Windows settings and provides a platform-independent implementation that works for web content on macOS, but on macOS, it is not customizable and can only be enabled by using Chrome developer tools.
        </p>
        <p>
          A contrast theme enables users to specify the colors that are used to render various kinds of UI elements, such as text, selected text, active controls, and inactive controls.
          When a contrast theme is enabled, the browser automatically replaces the colors an author specified for an element with the theme color that the user chose for that kind of element.
          For example, the Windows Dusk theme specifies powder blue #b6f6f0 as the color for the kind of elements known as <code>buttonText</code>.
          So, if the Dusk theme is active, the browser ignores author-specified colors and renders the text on buttons using powder blue #b6f6f0.
        </p>
        <p>
          CSS color module Level 4 specifies nineteen <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/color_value/system-color"><code>system color keywords</code></a>
          that are mapped to nineteen kinds of elements.
          While operating systems or browsers could enable users to design themes with up to nineteen colors, all implementations provide users with a much smaller and more practical number of choices.
          Windows themes map the nineteen system color keywords to eight colors (four foreground and four background) while Firefox custom contrast settings provide four color choices (two foreground and two background).
          Note that when using Firefox on Windows, it provides an option  to inherit the eight-color Windows theme.
        </p>
        <p>The following table shows the nineteen system color keywords and indicates which are supported in the Windows, Firefox, and Chromium implementations.</p>
        <div class="table-wrap"><table class="data">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div role="img" class="sample" aria-label="Button face is a light shade of gray" style="background-color: buttonface;"></div>
                <div class="color">#efefef</div>
              </td>
            ...
            <tr>
              ...
              <td>Button Text</td>
              <td>
                <div role="img" class="sample" aria-label="Button text is black" style="background-color: buttontext;"></div>
                <div class="color">#000000</div>
              </td>
            ...
            <tr>
              ...
              <td>Background</td>
              <td>
                <div role="img" class="sample" aria-label="Canvas is white" style="background-color: canvas;"></div>
            ...
            <tr>
              ...
              <td>Text</td>
              <td>
                <div role="img" class="sample" aria-label="Canvas text is black" style="background-color: canvastext;"></div>
                <div class="color">#000000</div>
              </td>
            ...
            <tr>
              ...
              <td>Button Background</td>
              <td>
                <div role="img" class="sample" aria-label="Field is white" style="background-color: field;"></div>
                <div class="color">#ffffff</div>
              </td>
            ...
            <tr>
              ...
              <td>
                <div role="img" class="sample" aria-label="Field text is black" style="background-color: fieldtext;"></div>
                <div class="color">#000000</div>
              </td>
            ...
            <tr>
              ...
              <td>Inactive Text</td>
              <td>
                <div role="img" class="sample" aria-label="Gray text is gray" style="background-color: graytext;"></div>
                <div class="color">#808080</div>
              </td>
              <td>Text color for disabled items (e.g. a disabled control)</td>
            </tr>
            <tr>
              <th>Highlight</th>
              <td>Selected Background</td>
              <td>
                <div role="img" class="sample" aria-label="Highlight is similar to powder blue" style="background-color: highlight;"></div>
                <div class="color">#b3d7fe</div>
              </td>
            ...
            <tr>
              ...
              <td>Selected Text</td>
              <td>
                <div role="img" class="sample" aria-label="Highlight text is black" style="background-color: highlighttext;"></div>
                <div class="color">#000000</div>
              </td>
            ...
            <tr>
              ...
              <td>Hyperlink</td>
              <td>
                <div role="img" class="sample" aria-label="Link text is similar to blue" style="background-color: linktext;"></div>
                <div class="color">#0000ee</div>
              </td>
        ...
        <h3>Contrast Themes Windows Example</h3>
        <p>The following table shows the default colors for each theme users can choose in Windows 11.</p>
        <div class="table-wrap"><table class="data">
          ...
          <tbody>
            <tr>
              <th>Background</th>
              <td>
                <div role="img" class="sample" aria-label="Background feature is a dark shade of gray" style="background-color: rgb(32, 32, 32);"></div>
                <div class="color">#202020</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Background feature is similar to light yellow" style="background-color: rgb(255, 250, 239);"></div>
                <div class="color">#fffaef</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Background feature is similar to dark slate gray" style="background-color: rgb(45, 50, 54);"></div>
                <div class="color">#2d3236</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Background feature is black" style="background-color: rgb(0, 0, 0);"></div>
                <div class="color">#000000</div>
              </td>
            </tr>
            <tr>
              <th>Text</th>
              <td>
                <div role="img" class="sample" aria-label="Text feature is white" style="background-color: rgb(255, 255, 255);"></div>
                <div class="color">#ffffff</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Text feature is a dark shade of gray" style="background-color: rgb(61, 61, 61);"></div>
                <div class="color">#3d3d3d</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Text feature is white" style="background-color: rgb(255, 255, 255);"></div>
                <div class="color">#ffffff</div>
            ...
            <tr>
              <th>Hyperlink</th>
              <td>
                <div role="img" class="sample" aria-label="Hyperlink feature is similar to aquamarine" style="background-color: rgb(117, 233, 252);"></div>
                <div class="color">#75e9fc</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Hyperlink feature is similar to dark cyan" style="background-color: rgb(28, 94, 117);"></div>
                <div class="color">#1c5e75</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Hyperlink feature is similar to aquamarine" style="background-color: rgb(112, 235, 222);"></div>
                <div class="color">#70ebde</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Hyperlink feature is similar to medium purple" style="background-color: rgb(128, 128, 255);"></div>
                <div class="color">#8080ff</div>
              </td>
            </tr>
            <tr>
              <th>Inactive Text</th>
              <td>
                <div role="img" class="sample" aria-label="Inactive Text feature is shade of gray" style="background-color: rgb(166, 166, 166);"></div>
                <div class="color">#a6a6a6</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Inactive Text feature is shade of gray" style="background-color: rgb(103, 103, 103);"></div>
                <div class="color">#676767</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Inactive Text feature is shade of gray" style="background-color: rgb(166, 166, 166);"></div>
                <div class="color">#a6a6a6</div>
            ...
            <tr>
              ...
              <td>
                <div role="img" class="sample" aria-label="Selected Background feature is similar to light sky blue" style="background-color: rgb(142, 227, 240);"></div>
                <div class="color">#8ee3f0</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Selected Background feature is similar to saddle brown" style="background-color: rgb(144, 57, 9);"></div>
                <div class="color">#903909</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Selected Background feature is similar to light steel blue" style="background-color: rgb(161, 191, 222);"></div>
                <div class="color">#a1bfde</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Selected Background feature is similar to thistle" style="background-color: rgb(214, 180, 253);"></div>
                <div class="color">#d6b4fd</div>
              </td>
            </tr>
            <tr>
              <th>Selected Text</th>
              <td>
                <div role="img" class="sample" aria-label="Selected Text feature is similar to dark slate gray" style="background-color: rgb(38, 59, 80);"></div>
                <div class="color">#263b50</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Selected Text feature is similar to light yellow" style="background-color: rgb(255, 245, 227);"></div>
                <div class="color">#fff5e3</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Selected Text feature is similar to dark slate gray" style="background-color: rgb(33, 45, 59);"></div>
                <div class="color">#212d3b</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Selected Text feature is a dark shade of gray" style="background-color: rgb(43, 43, 43);"></div>
                <div class="color">#2b2b2b</div>
              </td>
            </tr>
            <tr>
              <th>Button Background</th>
              <td>
                <div role="img" class="sample" aria-label="Button Background feature is a dark shade of gray" style="background-color: rgb(32, 32, 32);"></div>
                <div class="color">#202020</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Button Background feature is similar to light yellow" style="background-color: rgb(255, 250, 239);"></div>
                <div class="color">#fffaef</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Button Background feature is similar to dark slate gray" style="background-color: rgb(45, 50, 54);"></div>
                <div class="color">#2d3236</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Button Background feature is black" style="background-color: rgb(0, 0, 0);"></div>
                <div class="color">#000000</div>
              </td>
            </tr>
            <tr>
              <th>Button Text</th>
              <td>
                <div role="img" class="sample" aria-label="Button Text feature is white" style="background-color: rgb(255, 255, 255);"></div>
                <div class="color">#ffffff</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Button Text feature is a dark shade of gray" style="background-color: rgb(32, 32, 32);"></div>
                <div class="color">#202020</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Button Text feature is similar to powder blue" style="background-color: rgb(182, 246, 240);"></div>
                <div class="color">#b6f6f0</div>
              </td>
              <td>
                <div role="img" class="sample" aria-label="Button Text feature is similar to gold" style="background-color: rgb(255, 238, 50);"></div>
                <div class="color">#ffee32</div>
              </td>
            </tr>
          </tbody>
        </table></div>
        ...
        <h3>Contrast Theme Switch Example</h3>
  ...
  div[role="switch"].system-color {
    ...
    &:hover {
      background-color: ButtonFace;
        ...
        <h3>Testing Contrast Themes</h3>
        <ol>
          <li>Turn on a contrast theme in either Windows or Chrome:
            <ol>
              <li>
                Windows 10 or 11: Go to Settings &gt; Accessibility &gt; Contrast themes and select a theme.
                For more information, see <a href="https://support.microsoft.com/en-US/accessibility/windows/change-color-contrast-in-windows">Change color contrast in Windows in Microsoft Support</a>.
              </li>
              <li>
                Chrome: Use Render options in the DOM Inspector to <a href="https://developer.chrome.com/docs/devtools/rendering/emulate-css#emulate_css_media_feature_forced-colors">emulate forced-colors active</a>
                and then choose  between Chrome's light and dark themes by <a href="https://developer.chrome.com/docs/devtools/rendering/emulate-css#emulate_css_media_feature_prefers-color-scheme">emulating the prefers-color-scheme CSS media feature</a>.
              </li>
            </ol>
          </li>
          <li>
      ...
      <section id="svg">
        ...
        <p>Note: Bit-mapped images used for interactive components should meet <a href="https://www.w3.org/TR/WCAG21/#contrast-minimum">WCAG 1.4.3: Contrast (Minimum)</a> requirement.</p>

        <h3>Examples using <code>currentcolor</code>:</h3>
        ...
        <h3>Supporting <code>currentcolor</code></h3>

        <p>
          The SVG elements of custom components should match the color styling of other features in the component based on user settings, for example users applying a Contrast Theme in Microsoft Windows.  When SVG elements are used in custom components the <code>currentcolor</code> value can be used for <code>fill</code> and <code>stroke</code> properties to inherit color styling from ancestor elements, reducing the need for media queries to synchronize colors.
        </p>
      </section>
