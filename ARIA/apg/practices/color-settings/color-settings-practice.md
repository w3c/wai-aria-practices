  ...
  svg {
    ...
    circle {
      &.off {
        ...
        <ol>
          <li>
            Develop color palettes that are easy to read in both light and dark modes that specify styles for dark text on a light background and light text on a dark background.
