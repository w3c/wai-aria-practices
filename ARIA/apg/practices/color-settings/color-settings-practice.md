    ...
    circle {
      ...
      <section id="forced-colors">
        ...
        <p>
          ...
          Note that there are some slight variations in how Mozilla (e.g. Firefox) and Chromium (e.g. Chrome, Edge, Opera...) based browsers will render HTML controls, for example the <code>input[type="range']</code> control.  The custom theme colors are assigned to system colors and authors can use the system colors to define component features when forced colors media query is active.  The system colors used for the features of standard HTML controls provide guidance to authors on how to apply system colors in custom components.
        </p>
