  ...
  svg {
    ...
    circle {
      &.off {
        ...
        <ol>
          <li>
            Develop styles for dark text on a light background and light text on a dark background.
          ...
          <li>
            ...
            the media query identifies the current color scheme by returning <code>light</code> or <code>dark</code>.
          </li>
          <li>
            Instead of shadow styling use highlights and gradients, since shadow styling is difficult to perceive in dark mode.
          </li>
          <li>
        ...
        <ul>
          <li><a href="https://css-tricks.com/a-complete-guide-to-dark-mode-on-the-web/#design">CSS-Tricks: Dark Mode in CSS Guide</a></li>
          ...
          <li><a href="https://medium.com/@tundehercules/designing-effective-dark-mode-interfaces-17f38ecea2e9">Medium: How to Design Accessible Dark Mode Interfaces</a></li>
        </ul>
    ...
    &:hover {
      background-color: ButtonFace;
        ...
        <p>
          ...
          The colors in the table are the computed color for the operating system (e.g. Windows 10 or 11), browser and contrast theme you are using to view the table.
          Changing your contrast theme will update the computed colors in the table.
          The computed colors also may vary between operating systems and browsers.
        </p>
        <p>
