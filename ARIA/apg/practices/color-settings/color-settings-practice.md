  ...
  div[role="switch"].system-color {
    ...
    &:hover {
      background-color: ButtonFace;
        ...
        <p>The colors in the table are the computed color for the operating system (e.g. Windows 10 or 11) and browser you are using to view the table.  The computed colors may vary between operating systems and browsers.</p>
