...
....
        ...
        <p>The following list of colors are considered "safe" to use when a user enables a contrast theme.  Safe colors are color that use one of the theme colors and are supported in both Mozilla and Chromium based browsers.</p>
