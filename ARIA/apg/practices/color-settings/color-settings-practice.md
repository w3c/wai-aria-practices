...
<link
  rel="stylesheet"
  href="../../../../content-assets/wai-aria-practices/practices/color-settings/css/color-settings-practices.css"
/>
        ...
        <div class="table-wrap"><table class="data">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <p>
                  Accessibility setting that automatically transforms all rendered colors in all apps, including browser content, by subtracting each RGB value from 255.
            ...
            <tr>
              ...
              <td>
                Accessibility setting that specifies that the user prefers contrast that is stronger than the default minimum.
                Typically, rendering of apps and content is not automatically changed by the operating system; app and content developers need to provide support.
            ...
            <tr>
              ...
              <td>
                ...
                It typically defaults to the <code>light</code> color scheme.
                Typically, rendering of apps and content is not automatically changed by the operating system; app and content developers need to provide support.
            ...
            <tr>
              ...
              <td>
                Accessibility feature that automatically forces the operating system and apps to render content using an alternative color theme chosen by the user.
                Some of the themes are designed to provide extra high contrast, and users can customize their chosen color theme.
                Browser default styles respond to this setting using the system colors described below.
                The user-chosen theme does not automatically override author specified colors, so content can disappear in certain circumstances.
              </td>
              <td>
...
....
      ...
      <section id="forced-colors">
        ...
        <div class="table-wrap"><table class="data">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <p><input type="text" value="Sample value" size="15" aria-label="Text box Sample"></p>
              </td>
              <td>
                <ul class="system-colors">
                  <li>ButtonBorder</li>
            ...
            <tr>
              ...
              <td>
                <p><input type="range" aria-label="Sample Range"></p>
              </td>
              <td>
                <ul class="system-colors">
                  <li>ActiveText</li>
        ...
        <p>Authors should use either the <code>currentcolor</code> or <code>&lt;system-colors&gt;</code> values for CSS color properties for their components to adapt to user preferences.</p>

        <h3><code>currentcolor</code> vs. <code>&lt;system-colors&gt;</code></h3>

        <p>Use the <code>currentcolor</code> value when the component is using an existing HTML elements and their system color matches the semantics of the additional features of the component.  For example, this page includes an example  using the <code>button</code> element to create a switch.   The <code>currentcolor</code> value us used on the SVG elements to make sure they use the same color as the button elements for borders and text.</p>

        <p>Use <code>&lt;system-colors&gt;</code> values when not using HTML form controls to create components and when <code>currentcolor</code> is insufficient for matching the styling needs of the component.</p>
        ...
        <div class="example">
          <div role="switch" tabindex="-1" aria-checked="false" class="system-color">
            <span class="label">Living Room Lights</span>
            <svg xmlns="http://www.w3.org/2000/svg" height="20" width="36">
              <rect class="container" x="1" y="1" width="34" height="18" rx="9" ></rect>
        ...
        <h3>Using <code>currentcolor</code></h3>

        <p>The <code>currentcolor</code> keyword provides a means for components to use the color value of ancestors to set the color properties of an element, making <code>currentcolor</code> a convenient means for custom components using existing form controls like <code>input</code> and <code>button</code> elements to also automatically adapt to changes in contrast themes and dark color mode.  When the user chooses a contrast theme the browser changes the <code>color</code> and <code>background-color</code> values of HTML elements.   The <code>currentcolor</code> value is set to the color of the nearest ancestor element and can be used in setting the color of other properties including: <code>border</code> and <code>outline</code> on HTML elements, and <code>stroke</code> and <code>fill</code> properties on SVG elements.</p>

        <div class="support-notice">
          <div class="caution"><strong>Caution:</strong>
            There is no equivalent to the <code>currentcolor</code> value for setting the background color, so when using this technique it is important for verify the color contrast of the features of the component using <code>currentcolor</code> with the background color being rendered.
          </div>
        </div>
        ...
        <div class="table-wrap"><table class="data">
          ...
          <tbody>
            <tr>
              <td>Contrast Theme: none (default)</td>
              <td><img src="../../../../content-images/wai-aria-practices/practices/color-settings/images/currentcolor-windows11-theme-none.png" alt="Screen shot of switch example with no contrast theme applied" style="height: 90px"></td>
            </tr>
            <tr>
              <td>Contrast Theme: Desert</td>
              <td><img src="../../../../content-images/wai-aria-practices/practices/color-settings/images/currentcolor-windows11-theme-desert.png" alt="Screen shot of switch example with desert contrast theme applied" style="height: 95px"></td>
            </tr>
            <tr>
              <td>Contrast Theme: Night sky</td>
              <td><img src="../../../../content-images/wai-aria-practices/practices/color-settings/images/currentcolor-windows11-theme-night-sky.png" alt="Screen shot of switch example with night sky contrast theme applied" style="height: 87px"></td>
            </tr>
          </tbody>
        </table></div>
