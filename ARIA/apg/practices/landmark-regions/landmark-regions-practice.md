      ...
      <section>
        ...
        <div class="table-wrap"><table class="widget-features">
          ...
          <tbody>
            <tr>
              <td>
                <p><code>aside</code> if it is in the context of a <code>body</code>, <code>header</code>, <code>footer</code> or <code>main</code> element.</p>
                <p><strong>Note:</strong> The <code>aside</code> element will create a <code>complementary</code> if it has a label (see <a href="#aria_lh_step3">Step 3</a> below) in any context, including <code>article</code>, <code>aside</code>, <code>nav</code> or <code>section</code> elements.  It is <code>not</code> considered a best practice to create a complementary landmark in any context other than the body element.</p>
              </td>
      ...
      <section>
        ...
        <section id="aria_lh_complementary">
          ...
          <section>
            ...
            <ul>
              <li>Use the HTML <code>aside</code> element to define a <code>complementary</code> landmark when its context is the <code>body</code>, <code>footer</code>, <code>header</code> or <code>main</code> element.</li>
