            ...
            <tr>
              <td>
                <code>aside</code> if it has both:
                  <ol>
                    <li>
                      An accessible name provided by <code>aria-labelledby</code> or <code>aria-label</code>
                    </li>
                    <li>
        ...
        <section id="aria_lh_complementary">
          ...
          <section>
            ...
            <ul>
              ...
              <li>Use the HTML <code>aside</code> element with an <a href="https://www.w3.org/TR/accname-1.2/#dfn-accessible-name">accessible name</a> to define a <code>complementary</code> landmark when its context is an <code>article</code>, <code>aside</code>, <code>nav</code> or <code>section</code> element.</li>
            </ul>
