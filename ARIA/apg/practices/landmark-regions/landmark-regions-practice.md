      ...
      <section>
        ...
        <div class="table-wrap"><table class="widget-features">
          ...
          <tbody>
            <tr>
              <td>
                <p><code>aside</code> element if it is in the context of a <code>body</code>, <code>footer</code>, <code>header</code> or <code>main</code> element, or if the <code>aside</code> element has an label (see <a href="#aria_lh_step3">Step 3</a> below) in any context.</p>
