      ...
      <section>
        ...
        <div class="table-wrap"><table class="widget-features">
          ...
          <tbody>
            <tr>
              <td>
                <code>aside</code> if it is in the context of a <code>body</code> or <code>main</code> element, or has an <a href="https://www.w3.org/TR/accname-1.2/#dfn-accessible-name">accessible name</a> and is in the context of an <code>article</code>, <code>aside</code>, <code>nav</code> or <code>section</code> element.
              </td>
