    ...
    <div>
      ...
      <section>
        ...
        <div class="table-wrap"><table class="widget-features">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <code>aside</code> if it has both:
                  <ul>
                    <li>
                      A label provided by <code>aria-labelledby</code> or <code>aria-label</code>
                    </li>
                    <li>
                     Is in the context of an <code>article</code>, <code>aside</code>, <code>nav</code> or <code>section</code> element
                   </li>
                 </ul>
              </td>
              <td><code>complementary</code></td>
            ...
            <tr>
              <td><code>form</code> if it has a label provided by <code>aria-labelledby</code> or <code>aria-label</code></td>
            ...
            <tr>
              <td><code>section</code> if it has a label provided by <code>aria-labelledby</code> or <code>aria-label</code></td>
      ...
      <section>
        ...
        <ul>
          ...
          <li>If an area begins with a heading element (e.g. <code>h1-h6</code>) it can be used as the label for the area using <code>aria-labelledby</code>.</li>
      ...
      <section>
        ...
        <section id="aria_lh_complementary">
          ...
          <section>
            ...
            <ul>
              ...
              <li>Use the HTML <code>aside</code> element with a label to define a <code>complementary</code> landmark when its context is an <code>article</code>, <code>aside</code>, <code>nav</code> or <code>section</code> element.  A label is defined using <code>aria-labelledby</code> or <code>aria-label</code>.</li>
            </ul>
        ...
        <section id="aria_lh_form">
          ...
          <section>
            ...
            <p>The HTML <code>form</code> element defines a <code>form</code> landmark when it has a label defined using <code>aria-labelledby</code> or <code>aria-label</code>.</p>
        ...
        <section id="aria_lh_region">
          ...
          <section>
            ...
            <p>The HTML <code>section</code> element defines a <code>region</code> landmark when it has an label defined using <code>aria-labelledby</code> or <code>aria-label</code>.</p>
