      ...
      <section>
        ...
        <div class="table-wrap"><table class="widget-features">
          ...
          <tbody>
            <tr>
              <td>
                <code>aside</code> if it is in the context of a <code>body</code> or <code>main</code> element
              </td>
              <td><code>complementary</code></td>
            </tr>
            <tr>
              <td>
                <code>aside</code> if it has a label (see <a href="#aria_lh_step3">Step 3</a> below) and is in the context of an <code>article</code>, <code>aside</code>, <code>nav</code> or <code>section</code> element
              </td>
              <td><code>complementary</code></td>
            </tr>
            <tr>
