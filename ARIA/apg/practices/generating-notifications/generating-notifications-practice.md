...
title: "Using Live Regions and ARIA Notify to Generate Screen Reader Announcements"
ref: /ARIA/apg/practices/generating-notifications/

github:
  repository: w3c/aria-practices
  branch: main
  path: content/practices/generating-notifications/generating-notifications-practice.html
feedbackmail: public-aria-practices@w3.org
permalink: /ARIA/apg/practices/generating-notifications/
...
<title>
  Using Live Regions and ARIA Notify to Generate Screen Reader Announcements
</title>
...
<div>
  ...
  <div>
    ...
    <section id="introduction">
      <h2>Introduction</h2>
      <p>
        ARIA provides two ways of requesting screen readers to generate temporal, author-specified speech and braille output: live regions and ARIA notify.
        The ability to generate this "live notification" output is essential functionality when users need timely awareness of UI changes that do not automatically trigger accessibility API events.
        While live notifications have important use cases that can be essential to an accessible experience, careful design is critical because misuse or overuse often severely degrade accessibility.
      </p>
      <p>This practice provides:</p>
      <ul>
        <li>An overview that compares live regions and ARIA notify</li>
        <li>Design guidance for live notifications with appropriate use cases and best practices</li>
        <li>Live region usage guidance and examples</li>
        <li>ARIA notify API usage guidance and examples</li>
      </ul>
    </section>
    ...
    <section id=""overview">
      ...
      <p>
        Live regions and ARIA notify are both used to generate screen reader output (speech and braille) that informs users of important changes as they happen.
        Live regions are a declarative way to mark up content that is updated dynamically, while ARIA notify is a JavaScript API that allows developers to programmatically generate announcements.
        ... to be continued ...
      </p>
    </section>  

    <section id="design_guidance">
      <h2>Design Guidance for Live Notifications</h2>
      <p>
        ... to be continued ...
      </p>
    </section>
  ...
  &lt;/form&gt;
    ...
    <section id="aria_notify">
      <h2>ARIA Notify</h2>
      <p>
        ARIA Notify provides a JavaScript API ...
      </p>
    </section>    
