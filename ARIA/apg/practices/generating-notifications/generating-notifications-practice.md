...
<div>
  ...
  <div>
    ...
    <section id="introduction">
      <h2>Introduction</h2>
      <p>
        ARIA provides two ways of directly generating screen reader speech and braille output: live regions and ARIA notify.
        While these features have important use cases that are sometimes essential to an accessible experience, misuse or overuse severely degrades accessibility.
      </p>
      <p>This practice provides:</p>
      <ul>
        <li>An overview that compares live regions and ARIA notify</li>
        <li>Design guidance for automatic announcements with appropriate use cases and best practices</li>
        <li>Live region implementation guidance and examples</li>
        <li>ARIA notify implementation guidance and examples</li>
      </ul>
    </section>
