...
<div>
    ...
    <div>
      ...
      <section id="testing">
        ...
        <p>High contrast testing requires setting operating system contrast features or using browser extensions or configuration features.  </p>
        ...
        <h3 id="browser-high-contrast-config">Chrome High Contrast Options</h3>
