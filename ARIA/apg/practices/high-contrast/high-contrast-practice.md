    ...
    <div>
      ...
      <section id="introduction">
        ...
        <ol>
          ...
          <li>Using the CSS media queries that support user color and contrast settings (<code>prefers-contrast</code>, <code>prefers-color-theme</code>, and <code>forced-colors</code>).</li>
