...
ref: /WAI/ARIA/APG/patterns/menu/
...
permalink: /WAI/ARIA/APG/patterns/menu/
...
<section class="widget" id="menu"><h2 id="about-this-pattern" tabindex="-1">About This Pattern</h2><div class="header-wrapper"></div>
      ...
      <p>
        ...
        A menu is usually opened, or made visible, by activating a <a href="/WAI/ARIA/APG/patterns/menubutton/">menu button</a>, choosing an item in a menu that opens a sub menu, or by invoking a command, such as <kbd>Shift + F10</kbd> in Windows, that opens a context specific menu.
      ...
      <section class="notoc"><div class="header-wrapper"><h2 id="keyboard-interaction-12" tabindex="-1">Keyboard Interaction</h2></div>
        ...
        <ul>
          <li>
            ...
            All items are focusable as described in <a href="/WAI/ARIA/APG/practices/keyboard-interface/#kbd_general_within" class="sec-ref"> Keyboard Navigation Inside Components</a>.
          </li>
          <li><kbd>Enter</kbd>:
            <ul>
      ...
      <section class="notoc"><div class="header-wrapper"><h2 id="wai-aria-roles-states-and-properties-13" tabindex="-1"><abbr title="Accessible Rich Internet Applications">WAI-ARIA</abbr> Roles, States, and Properties</h2></div>
        ...
        <ul>
          ...
          <li>One of the following approaches is used to enable scripts to move focus among items in a menu as described in <a href="/WAI/ARIA/APG/practices/keyboard-interface/#kbd_general_within" class="sec-ref"> Keyboard Navigation Inside Components</a>:
            <ul>
