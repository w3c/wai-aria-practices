...
<div>
      ...
      <section class="notoc"><div class="header-wrapper"><h2 id="keyboard-interaction-4" tabindex="-1">Keyboard Interaction</h2></div>
        ...
        <ul>
          ...
          <li>
            Button elements implement the keyboard interaction defined in the <a href="{{ site.baseurl }}/patterns/button/">button pattern</a>.
          ...
          <li>If tab elements are used for slide picker controls, they implement the keyboard interaction defined in the <a href="{{ site.baseurl }}/patterns/tabpanel/">Tabs Pattern.</a></li>
        </ul>
      </section>
      ...
      <section class="notoc"><div class="header-wrapper"><h2 id="wai-aria-roles-states-and-properties-4" tabindex="-1"><abbr title="Accessible Rich Internet Applications">WAI-ARIA</abbr> Roles, States, and Properties</h2></div>
        ...
        <ul>
          ...
          <li>Tabbed: Has basic controls plus a single tab stop for slide picker controls implemented using the <a href="{{ site.baseurl }}/patterns/tabpanel/">tabs pattern.</a></li>
          <li>Grouped: Has basic controls plus a series of tab stops in a group of slide picker controls where each control implements the <a href="{{ site.baseurl }}/patterns/button/">button pattern.</a> Because each slide selector button adds an element to the page tab sequence, this style is the least friendly for keyboard users.</li>
        </ul>
        ...
        <ul>
          ...
          <li>The rotation control, next slide control, and previous slide control are either native button elements (recommended) or implement the <a href="{{ site.baseurl }}/patterns/button/">button pattern</a>.</li>
          <li>
        ...
        <ul>
          ...
          <li>It has slide picker controls implemented using the <a href="{{ site.baseurl }}/patterns/tabpanel/">tabs pattern</a> where:
            <ul>
              ...
              <li>The <code>tab</code>, <code>tablist</code>, and <code>tabpanel</code> implement the properties specified in the <a href="{{ site.baseurl }}/patterns/tabpanel/">tabs pattern</a>.</li>
            </ul>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>Each picker control is a native button element (recommended) or implements the <a href="{{ site.baseurl }}/patterns/button/">button pattern.</a></li>
          <li>
