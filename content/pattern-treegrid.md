...
<div>
      ...
      <section class="notoc examples-section"><img alt="" src="{{ site.baseurl }}/assets/img/treegrid.svg" ><div class="header-wrapper"><h2 id="examples-16" tabindex="-1">Examples</h2></div>
