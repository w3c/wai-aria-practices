        ...
        <div class="sidebar-container">
          <aside class="sidebar-left">
            ...
            <ul class="sidebar-list">
                  ...
                  <li>
                    <a href="#x5-3-cardinal-rules-of-naming">Cardinal Rules of Naming</a>
                  </li>
                 
                  <li>
                    <a href="#x5-4-naming-techniques">Naming Techniques</a>
                  </li>
                 
                  <li>
                    <a href="#x5-5-composing-effective-and-user-friendly-accessible-names">Composing Effective and User-friendly Accessible Names</a>
                  </li>
                 
                  <li>
                    <a href="#x5-6-accessible-name-guidance-by-role"><span id="naming_role_guidance_heading">Accessible Name Guidance by Role</span></a>
                  </li>
                 
                  <li>
                    <a href="#x5-7-accessible-name-calculation">Accessible name calculation</a>
                  </li>
                 
                  <li>
                    <a href="#x5-8-describing-techniques">Describing Techniques</a>
                  </li>
                 
                  <li>
                    <a href="#x5-9-accessible-description-calculation">Accessible description calculation</a>
                  </li>
...
However, most authors do not need such detailed understanding of the algorithms since nearly all circumstances where a name or description is useful are supported by the coding patterns described in the <a href="/fundamentals/names-and-descriptions/#naming_techniques">naming techniques</a> and <a href="/fundamentals/names-and-descriptions/#describing_techniques">describing techniques</a> sections.
      ...
      <section id="naming_cardinal_rules"><div class="header-wrapper"><h3 id="x5-3-cardinal-rules-of-naming">Cardinal Rules of Naming</h3></div>
        

        <section id="naming_rule_heed_warnings"><div class="header-wrapper"><h4 id="x5-3-1-rule-1-heed-warnings-and-test-thoroughly">Rule 1: Heed Warnings and Test Thoroughly</h4></div>
        ...
        <section id="naming_rule_visible_text"><div class="header-wrapper"><h4 id="x5-3-2-rule-2-prefer-visible-text">Rule 2: Prefer Visible Text</h4></div>
        ...
        <section id="naming_rule_native_techniques"><div class="header-wrapper"><h4 id="x5-3-3-rule-3-prefer-native-techniques">Rule 3: Prefer Native Techniques</h4></div>
        ...
        <section id="naming_rule_avoid_fallback"><div class="header-wrapper"><h4 id="x5-3-4-rule-4-avoid-browser-fallback">Rule 4: Avoid Browser Fallback</h4></div>
        ...
        <section id="naming_rule_brief_names"><div class="header-wrapper"><h4 id="x5-3-5-rule-5-compose-brief-useful-names">Rule 5: Compose Brief, Useful Names</h4></div>
      ...
      <section id="naming_techniques"><div class="header-wrapper"><h3 id="x5-4-naming-techniques">Naming Techniques</h3></div>
        

        <section id="naming_with_child_content"><div class="header-wrapper"><h4 id="x5-4-1-naming-with-child-content">Naming with Child Content</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
        ...
        <section id="naming_with_aria-label"><div class="header-wrapper"><h4 id="x5-4-2-naming-with-a-string-attribute-via-aria-label">Naming with a String Attribute Via <code>aria-label</code></h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">nav</span>&gt;</span></code></pre>
        ...
        <section id="naming_with_aria-labelledby"><div class="header-wrapper"><h4 id="x5-4-3-naming-with-referenced-content-via-aria-labelledby">Naming with Referenced Content Via <code>aria-labelledby</code></h4></div>
...
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"download-details"</span>&gt;</span>PDF, 2.4 MB<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span></code></pre>
        ...
        <section id="naming_with_labels"><div class="header-wrapper"><h4 id="x5-4-4-naming-form-controls-with-the-label-element">Naming Form Controls with the Label Element</h4></div>
...
<span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"subscribe_checkbox"</span>&gt;</span>subscribe to our newsletter<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span></code></pre>
        ...
        <section id="naming_with_legends"><div class="header-wrapper"><h4 id="x5-4-5-naming-fieldsets-with-the-legend-element">Naming Fieldsets with the Legend Element</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">fieldset</span>&gt;</span></code></pre>
        ...
        <section id="naming_with_captions"><div class="header-wrapper"><h4 id="x5-4-6-naming-tables-and-figures-with-captions">Naming Tables and Figures with Captions</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">figure</span>&gt;</span></code></pre>
        ...
        <section id="naming_with_fallback"><div class="header-wrapper"><h4 id="x5-4-7-fallback-names-derived-from-titles-and-placeholders">Fallback Names Derived from Titles and Placeholders</h4></div>
...
<span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">search</span> <span class="hljs-attr">name</span>=<span class="hljs-string">q</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"Search"</span>&gt;</span></code></pre>
      ...
      <section id="naming_effectively"><div class="header-wrapper"><h3 id="x5-5-composing-effective-and-user-friendly-accessible-names">Composing Effective and User-friendly Accessible Names</h3></div>
      ...
      <section id="naming_role_guidance"><div class="header-wrapper"><h3 id="x5-6-accessible-name-guidance-by-role"><span id="naming_role_guidance_heading">Accessible Name Guidance by Role</span></h3></div>
      ...
      <section id="name_calculation"><div class="header-wrapper"><h3 id="x5-7-accessible-name-calculation">Accessible name calculation</h3></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
        ...
        <section id="name_calculation_non-recursive_ex"><div class="header-wrapper"><h4 id="x5-7-1-examples-of-non-recursive-accessible-name-calculation">Examples of non-recursive accessible name calculation</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span></code></pre>
          ...
          <section id="name_calculation_recursive_ex"><div class="header-wrapper"><h4 id="x5-7-2-examples-of-recursive-accessible-name-calculation">Examples of recursive accessible name calculation</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
      ...
      <section id="describing_techniques"><div class="header-wrapper"><h3 id="x5-8-describing-techniques">Describing Techniques</h3></div>
        
        <section id="describing_with_aria-describedby"><div class="header-wrapper"><h4 id="x5-8-1-describing-by-referencing-content-with-aria-describedby">Describing by referencing content with <code>aria-describedby</code></h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span></code></pre>
        ...
        <section id="describing_with_captions"><div class="header-wrapper"><h4 id="x5-8-2-describing-tables-and-figures-with-captions">Describing Tables and Figures with Captions</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">figure</span>&gt;</span></code></pre>
        ...
        <section id="describing_with_title"><div class="header-wrapper"><h4 id="x5-8-3-descriptions-derived-from-titles">Descriptions Derived from Titles</h4></div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span></code></pre>
      ...
      <section id="description_calculation"><div class="header-wrapper"><h3 id="x5-9-accessible-description-calculation">Accessible description calculation</h3></div>
