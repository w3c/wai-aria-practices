...
<div>
      ...
      <section class="notoc examples-section"><img alt="" src="{{ site.baseurl }}/assets/img/toolbar.svg" ><div class="header-wrapper"><h2 id="example-7" tabindex="-1">Example</h2></div>
