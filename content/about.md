...
<div>
      ...
      <dt>Editors:</dt>
      <dd class="p-author h-card vcard" data-editor-id="44582"><a class="ed_mailto u-email email p-name" href="mailto:mck@fb.com">Matt King</a> (Facebook) </dd><dd class="p-author h-card vcard" data-editor-id="74097"><a class="ed_mailto u-email email p-name" href="mailto:jku@illinois.edu">JaEun Jemma Ku</a> (University of Illinois) </dd><dd class="p-author h-card vcard" data-editor-id="37155"><a class="ed_mailto u-email email p-name" href="mailto:nurthen@adobe.com">James Nurthen</a> (Adobe) </dd><dd class="p-author h-card vcard" data-editor-id="74040"><span class="p-name fn">Zoë Bijl</span> (Invited Expert) </dd><dd class="p-author h-card vcard" data-editor-id="34017"><a class="ed_mailto u-email email p-name" href="mailto:cooper@w3.org">Michael Cooper</a> (W3C) </dd>
      <dt>
              Former editors:
            </dt><dd class="p-author h-card vcard" data-editor-id="42279"><span class="p-name fn">Joseph Scheuhammer</span> (Inclusive Design Research Centre, OCAD University)  -  Until <time datetime="2014-10-01">01 October 2014</time></dd><dd class="p-author h-card vcard" data-editor-id="41725"><span class="p-name fn">Lisa Pappas</span> (SAS)  -  Until <time datetime="2009-10-01">01 October 2009</time></dd><dd class="p-author h-card vcard" data-editor-id="2460"><span class="p-name fn">Rich Schwerdtfeger</span> (IBM Corporation)  -  Until <time datetime="2014-10-01">01 October 2014</time></dd>
      
      <dt>Participate:</dt><dd>
    <a href="https://github.com/w3c/aria-practices/">GitHub w3c/aria-practices</a>
  </dd><dd>
    <a href="https://github.com/w3c/aria-practices/issues/">File a bug</a>
  </dd><dd>
    <a href="https://github.com/w3c/aria-practices/commits/gh-pages">Commit history</a>
  </dd><dd>
  ...
  <p>
    ...
    <a href="https://github.com/w3c/aria-practices/issues/">GitHub Issues</a> are preferred for
          discussion of this specification.
        
    Alternatively, you can send comments to our mailing list.
          Please send them to
          <a href="mailto:public-aria@w3.org">public-aria@w3.org</a>
          (<a href="https://lists.w3.org/Archives/Public/public-aria/">archives</a>).
    ...
    document as other than work in progress.
       ...
       The group does not expect this document to become a <abbr title="World Wide Web Consortium">W3C</abbr> Recommendation.
                ...
                <a rel="disclosure" href="https://www.w3.org/2004/01/pp-impl/83726/status">public list of any patent disclosures</a>
